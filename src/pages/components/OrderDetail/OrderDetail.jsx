...
// import { Box, Flex, Text, VStack, HStack, Button, Image, Divider, Tag } from '@chakra-ui/react';
...
//   return (
//     <Box maxWidth="800px" margin="auto" p={5} borderWidth="1px" borderRadius="lg">
//       <VStack spacing={4} align="stretch">
//         {/* Order Header */}
//         <Flex justifyContent="space-between" alignItems="center">
//           <Text fontSize="lg" fontWeight="bold">#W24156</Text>
//           <Button size="sm">Refund</Button>
//           {/* Add other buttons like 'Return', 'Edit' as needed */}
//         </Flex>
...
//               <HStack>
//                 <Image src="/path-to-your-image.jpg" boxSize="50px" />
//                 <VStack align="start">
...
//           <HStack justifyContent="space-between">
//             <Text>Subtotal</Text>
//             <Text>{/* Calculate subtotal here */}</Text>
//           </HStack>
//           <HStack justifyContent="space-between">
//             <Text>Shipping</Text>
...
//           <HStack justifyContent="space-between">
//             <Text>Total</Text>
//             <Text>{/* Calculate total here */}</Text>
//           </HStack>
//         </VStack>
...
//           {/* Add other tags like 'Fulfilled', 'Delivered' */}
//         </HStack>

//         <Box>
//           <Text>Notes</Text>
//           {/* Add any notes or other info */}
//         </Box>
...
const OrderPage = () => {
  ...
  return (
    <Flex maxWidth="1000px" margin="auto" p={5} direction={{ base: 'column', lg: 'row' }} gap={5}>
      {/* Left Column */}
      <Box flex="2" borderWidth="1px" borderColor={borderColor} borderRadius="lg" p={5}>
        {/* Order Header */}
        <Flex justifyContent="space-between" alignItems="center" mb={5}>
          <Text fontSize="xl" fontWeight="bold">Order #W24156</Text>
          <Button colorScheme="blue">Refund</Button>
        </Flex>
      ...
      {/* Right Column */}
      <Box flex="1" borderWidth="1px" borderColor={borderColor} borderRadius="lg" p={5}>
        <VStack spacing={5} alignItems="stretch">
          {/* Customer Details */}
