...
const ProfileBox = () => {
  return (
    <Menu>
      <MenuButton
        as={Button}
        variant="ghost" // Change to ghost variant for a cleaner look
        p={4}
        borderRadius="md"
        _hover={{ boxShadow: "md", background: "#333" }} // Adjust hover effect color
        justifyContent="space-between"
      >
        <Flex align="center">
          <Avatar size="sm" name="John Doe" src="https://bit.ly/broken-link" />
          <Text ml={4} fontWeight="semibold" color="white"> {/* Set text color to white */}
            John Doe
          </Text>
        </Flex>
        <ChevronDownIcon color="white" /> {/* Set dropdown icon color to white */}
      </MenuButton>

      <MenuList bg="black" color="white"> {/* Set dropdown background and text color */}
        <MenuItem>Manage Account</MenuItem>
        {/* <MenuItem>Change Password</MenuItem> */}
        <MenuItem>Logout</MenuItem>
      </MenuList>
